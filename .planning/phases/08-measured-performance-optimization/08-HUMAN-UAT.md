...
reason: "Blocked in current environment: {bench} package is not installed (observed: bench_missing)."
...
result: blocked
blocked_by: server
reason: "Blocked in current environment: Quarto runtime is unavailable (observed: quarto_missing)."
