...
- [ ] 04-03-PLAN.md -- Create vignettes and finish roxygen docs/examples for the exported API
- [ ] 04-04-PLAN.md -- Regenerate package docs and complete the final `R CMD check --as-cran` hardening sweep
...
| 4. Tests, Documentation, and CRAN Hardening | 0/4 | Planned | - |
