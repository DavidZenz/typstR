...
- [ ] **Phase 1: Skeleton and Pipeline** - CRAN-ready package skeleton, extension bundling, scaffolding for working papers, and an end-to-end render that produces a PDF
...
|-------|----------------|--------|-----------|
| 1. Skeleton and Pipeline | 0/TBD | Not started | - |
